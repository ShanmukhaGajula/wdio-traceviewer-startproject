import TraceService from './services/trace/wdio-trace.service.js';
...
export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        browserVersion: '142',
        webSocketUrl: true  // Required for BiDi protocol commands
    }],
    ...
    services: [
        ...
        [TraceService, {
            ...
            // Capture screenshots before/after each action (with element highlighting)
            screenshots: true,
            ...
            // Maximum snapshots
            maxSnapshots: 500,
            // Highlight color for target elements
